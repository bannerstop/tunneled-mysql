...
namespace Bannerstop\TunneledMysql\MySQL;
...
class MySqlTunnel
{
    ...
    public function run(): PDO
    {
        ...
        if (!is_resource($this->process)) {
            throw new RuntimeException('Could not establish SSH tunnel.');
        }
        ...
        try {
            ...
            throw new RuntimeException($e ? $e->getMessage() : 'Timeout error. Cannot establish MySQL connection');
            ...
            throw new RuntimeException('Could not connect to MySQL via SSH tunnel: ' . implode(' | ', $errors));
        }
    }
